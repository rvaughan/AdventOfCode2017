#!/usr/bin/env python
"""
This code holds the solution for part 2 of day 7 of the Advent of Code for 2015.
"""
import sys
...
with open("input.txt", "r") as f:
    ...
    # We can ignore wire b as it's now been disconnected.
    wires = [wire for wire in wires if wire.output != 'b']

    # Reset the signals, and override the signal for wire b.
    signals = {'b': signals['a']}

    # Reset all of the remaining wires
