#!/usr/bin/env python
"""
This code holds the solution for part 2 of day 8 of the Advent of Code for 2018.
"""
...
class Node(object):
    ...
    def calc_value(self):
        ...
        if len(self.children) == 0:
            ...
            for idx in self.metadata:
                try:
                    value += self.children[idx-1].calc_value()
                except IndexError:
                    pass
    ...
    def dump(self, indent=0):
        ...
        output += " {} {} [{}]".format(len(self.children), self.metadata, self.calc_value())
...
node_value = tree.calc_value()
assert node_value == 66, node_value
...
with open("input.txt", "r") as f:
    ...
    print "Solution is {0}".format(node_value)
