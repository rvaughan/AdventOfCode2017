#!/usr/bin/env python
"""
This code holds the solution for part 2 of day 19 of the Advent of Code for 2017.
"""
...
with open("test_input.txt", "r") as f:
    ...
    path, num_steps = process_maze(maze)

    if path != "ABCDEF":
        print 'Wrong path. {0}'.format(path)
        sys.exit(-1)
    if num_steps != 38:
        print 'Wrong number of steps. {0}'.format(num_steps)
        sys.exit(-1)
