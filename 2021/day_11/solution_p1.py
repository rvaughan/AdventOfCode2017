#!/usr/bin/env python3
"""
This code holds the solution for part 1 of day 11 of the Advent of Code for 2021.
"""
...
def run_test(test_input, num_steps, expected_value):
    ...
    if result != expected_value:
        print(f'Test for {test_input} with {num_steps} steps FAILED. Got a result of {result}, not {expected_value}')
        sys.exit(-1)
...
19991
11111"""
result = run_test(test_input, 1, 9)
...
4846848554
5283751526"""
result = run_test(test_input, 10, 204)
...
4846848554
5283751526"""
result = run_test(test_input, 100, 1656)
...
with open('input.txt', 'r') as f:
    ...
    answer = calculate_solution(input_vals, 100)
