#!/usr/bin/env python3
"""
This code holds the solution for part 2 of day 7 of the Advent of Code for 2021.
"""
...
score = calc_fuel_use(5, [16,1,2,0,4,2,7,1,2,14])
assert score == 168, score

score = calc_fuel_use(2, [16,1,2,0,4,2,7,1,2,14])
assert score == 206, score

result = run_test(test_input, 5, 168)
