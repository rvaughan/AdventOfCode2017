#!/usr/bin/env python
"""
This code holds the solution for part 2 of day 5 of the Advent of Code for 2020.
"""
import sys
...
def calculate_solution(boarding_passes):
    ...
    for boarding_pass in boarding_passes:
        seats.append(calc_seat_id(identify_row(boarding_pass), identify_seat(boarding_pass)))
