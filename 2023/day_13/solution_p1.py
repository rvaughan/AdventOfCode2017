#!/usr/bin/env python3
"""
This code holds the solution for part 1 of day 13 of the Advent of Code for 2023.
"""
import sys
...
def horizontal_value(pattern):
    ...
    for i in range(len(pattern) - 1):
        ...
        # If there weren't any differences...
        if tot_dist == 0:
            result += i + 1
...
result = run_test('input.ex1', 5)

result = run_test('input.ex2', 400)

result = run_test('input.ex3', 405)
