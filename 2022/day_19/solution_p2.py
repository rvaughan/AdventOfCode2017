...
def calculate_solution(items):
    ...
    for blueprint in blueprints:
        ...
        if b_id < 4:
            print(f'Solving for blueprint #{b_id}')
            score = solve(o_cost, c_cost, ob_cost_ore, ob_cost_clay, g_cost_ore, g_cost_obs, 32)
            print(score)
            scores *= score
        else:
            break
...
# result = run_test(test_list, 124)

# test_list = """Blueprint 1: Each ore robot costs 4 ore. Each clay robot costs 2 ore. Each obsidian robot costs 3 ore and 14 clay. Each geode robot costs 2 ore and 7 obsidian.
# Blueprint 2: Each ore robot costs 2 ore. Each clay robot costs 3 ore. Each obsidian robot costs 3 ore and 8 clay. Each geode robot costs 3 ore and 12 obsidian."""
# result = run_test(test_list, 6944)
